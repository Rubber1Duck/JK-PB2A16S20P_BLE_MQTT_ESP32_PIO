...
const MqttPublishField DEVICE_FIELDS[] = {
    ...
    {"dry1_trigger", "Relais 1 Trigger"},
    {"dry1_trigger_txt", "Relais 1 Triggertext"},
    {"dry1_trigger_value", "Relais 1 Triggerwert"},
    {"dry1_release_value", "Relais 1 Rücksetzwert"},
    {"dry2_trigger", "Relais 2 Trigger"},
    {"dry2_trigger_txt", "Relais 2 Triggertext"},
    {"dry2_trigger_value", "Relais 2 Triggerwert"},
    {"dry2_release_value", "Relais 2 Rücksetzwert"},
...
const MqttPublishField CONFIG_FIELDS[] = {
    ...
    {"vol_cell_ov", "OVP"},
    {"vol_cell_ovpr", "OVPR"},
    {"vol_balan_trig", "Zelldifferenz-Balance-Start"},
    {"vol_100_percent", "100 % Zellspannung"},
    {"vol_0_percent", "0 % Zellspannung"},
    {"vol_cell_rcv", "RCV"},
    {"vol_cell_rfv", "RFV"},
    ...
    {"scp_delay", "SCP Delay"},
    {"vol_start_balance", "Zellspannung-Balance-Start"},
...
const MqttPublishField CELL_FIELDS[] = {
    ...
    {"temperatures/temp_sensor1", "Temp-Sensor 1"},
    {"temperatures/temp_sensor2", "Temp-Sensor 2"},
    {"alarms/alarm_raw", "Alarm Rohwert"},
    {"alarms/alarms_mask", "Alarm Bitmaske"},
    {"alarms/*", "Einzelne Alarmmeldung"},
    ...
    {"temperatures/temp_sensor3", "Temp-Sensor 3"},
    {"temperatures/temp_sensor4", "Temp-Sensor 4"},
    {"temperatures/temp_sensor5", "Temp-Sensor 5"},
    {"rtc_ticks", "RTC-Ticks"},
    {"time_enter_sleep", "Schlafbeginn"},
    {"pcl_module_status", "PCL-Modulstatus"},
    {"charge_status_time", "Ladestatuszeit"},
    {"charge_status", "Ladestatus"},
    {"dry_contact_1", "Relais 1"},
    {"dry_contact_2", "Relais 2"},
