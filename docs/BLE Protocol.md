|Device Info Frame|							
|BMS Version|Index|Type|Length|R/W|Content|Unit|Note|
...
all	0x002A - 0x002D	UINT32	4	R	PWROnTimes	#	Little-endian
...
all	0x0106 - 0x0109	UINT32	4	RW	DataStoredPeriod	?	Little-endian
